...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="container mx-auto mt-8">
        <h1 class="text-3xl font-bold text-center text-blue-600 mb-6">Jobs</h1>
        <p class="text-gray-700 text-center mb-6">Explore various job recommendations tailored to different MBTI personality types.</p>
        ...
        <div class="container mx-auto mt-4">
            <nav class="text-sm text-gray-600">
                <ol class="list-reset flex">
                    ...
                    <li class="text-gray-700">Jobs</li>
                </ol>
            </nav>
        </div>
